package net.springboot.javaguides.service.impl;
...
import net.springboot.javaguides.repo.RoleRepository;
import net.springboot.javaguides.repo.UserRepository;
